    ...
    <View style={styles.appointmentContainer}>
      <View style= {[styles.frame, styles.frameFlexBox]}>
        ...
        <View style= {[styles.frame1, styles.frameLayout]}>
          <Pressable onPress={()=> navigation.navigate("Community Resources1")}>
            <Text style= {styles.needARide}>Need a ride?</Text>
          </Pressable>
          <View style={[styles.frame2, styles.frameLayout]}>
            <Image
            style= {styles.apptNotesBtn}/>
              <Text style= {[styles.appointmentNotes, styles.textTypo]}>Appointment Notes</Text>
          </View>
        </View>
      </View> 
