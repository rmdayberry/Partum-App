...
const AppointmentContainer = () => {
  ...
  return (
    ...
    <View style={styles.frame3}>
      <Text style= {styles.appointmentDate}>{/* Appt. Date/Time here */} Wednesday, Nov 15 at 10:00 AM</Text>
      <View style={styles.clinicLocation}>
        ...
        <Text style= {styles.clinicName}>
          Riverland Community Health {/* Clinic name pulled from appt. details */}
        </Text>
      </View>
    </View>
</View>
