  ...
  return (
    <View style={styles.appointmentContainer}>
      <View style={[styles.frame, styles.frameFlexBox]}>
        <Text style={styles.in2DaysContainer}>
          <Text style={styles.in2DaysContainer1}>
        ...
        <View style={[styles.frame1, styles.frameLayout]}>
          ...
          <View style={[styles.frame2, styles.frameLayout]}>
            <Image
              ...
              contentFit="cover"
              source={require("../assets/screenshot-20241108-at-32224-pm-1.png")}
            />
      ...
      <View style={styles.frame3}>
        <Text style={styles.wednesdayNov15}>Wednesday, Nov 15 at 10:00 AM</Text>
        <View style={styles.clinicLocation}>
          <Image
            style={styles.locationOn24dp5f6368Fill0Icon}
            contentFit="cover"
            source={require("../assets/location.png")}
          />
          <Text style={styles.riverlandCommunityHealth}>
