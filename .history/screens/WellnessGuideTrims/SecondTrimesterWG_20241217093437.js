...
const translations ={
  sleep:{
    English:{
      ...
      challengesTitle: "Common Sleep Challenges in the Second Trimester:",
      challenges: [
        {
          title: "Finding a Comfortable Position:",
          details:
    ...
    Español: {
      ...
      challengesTitle: "Desafíos Comunes del Sueño en el Segundo Trimestre:",
      challenges: [
        {
          title: "Encontrar una Posición Cómoda:",
          details:
