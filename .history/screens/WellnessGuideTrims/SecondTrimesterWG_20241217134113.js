    ...
    English: {
      ...
      sections: [
        ...
        },
        {
          ...
          subtitle: "Create a Relaxing Bedtime Routine:",
        },
      ],
    },
    Español: {
      ...
      sections: [
        {
          ...
          bulletPoints: [
            "A medida que tu vientre crece, dormir boca arriba se vuelve menos cómodo y no se recomienda, ya que puede reducir el flujo de sangre al bebé.",
            "Dormir de lado, especialmente del lado izquierdo, es lo mejor para el flujo sanguíneo y para reducir la hinchazón.",
            "Considera usar una almohada de embarazo para apoyar tu vientre, colocarla entre las rodillas y detrás de la espalda.",
          ],
        },
        {
          subtitleBold: "Idas Frecuentes al Baño:",
          bulletPoints: [
            "Tu útero en crecimiento ejerce presión sobre la vejiga, lo que provoca necesidad de orinar frecuentemente, incluso por la noche.",
            "Intenta limitar los líquidos una o dos horas antes de acostarte, pero asegúrate de mantenerte hidratada durante el día.",
          ],
        },
        {
          subtitleBold: "Calambres en las Piernas:",
          bulletPoints:
            "Muchas personas experimentan calambres en las piernas durante el segundo trimestre. Estirar suavemente antes de acostarte y mantenerte hidratada puede ayudar.",
        },
        {
          subtitleBold: "Acidez Estomacal:",
          bulletPoints: [
            "Los cambios hormonales pueden relajar la válvula entre el estómago y el esófago, causando acidez, especialmente al acostarte.",
            "Evita comidas pesadas antes de dormir y considera usar almohadas para dormir ligeramente inclinada.",
          ],
        },
        {
          subtitleBold: "Sueños Vivos o Insomnio:",
          bulletPoints:
            "Las hormonas, el estrés o la emoción del embarazo pueden provocar sueños vívidos o dificultad para conciliar el sueño.",
        },
      ],
    },
  },
