...
const translations = {
  sleep: {
    English: {
      ...
      title1: "Common Sleep Challenges in the Second Trimester:",
      content1: [
        {
      ...
      title2: "Tips for Better Sleep in the Second Trimester:",
      content2: [
  ...
  exercise: {
    English: {
      ...
      title1: "Benefits of Exercise in the Second Trimester:",
      content1: [
...
const SecondTrimester = () => {
  ...
  const renderContent = () => {
    const { heading, content, title1, content1, title2, content2, title3 } =
