...
const topicImages = {
  ...
  exercise: require("../../assets/NutritionWG.png"),
  symptoms: require("../../assets/NutritionWG.png"),
  support: require("../../assets/NutritionWG.png.png"),
  labor: require("../../assets/NutritionWG.png.png"),
};
