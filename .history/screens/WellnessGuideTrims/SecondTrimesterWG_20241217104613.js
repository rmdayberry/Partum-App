        ...
        sections: [
          {
            ...
            bulletPoints: [
              "Iron: Supports your increased blood volume and helps prevent anemia. Sources: Red meat, spinach, lentils, pumpkin seeds, and iron-fortified cereals. Tip: Pair with Vitamin C for better absorption.",
              ...
              "Omega-3 Fatty Acids (DHA): Support your baby’s brain and eye development. Sources: Fatty fish like salmon, chia seeds, flaxseeds, walnuts, and supplements. Tip: Choose low-mercury fish and aim for 2-3 servings per week.",
              "Protein: Essential for your baby’s growth and tissue development. Sources: Chicken, turkey, eggs, beans, lentils, tofu, Greek yogurt, and nuts. Tip: Aim for 70-100 grams of protein daily.",
              ...
              "Magnesium: Supports muscle function, reduces leg cramps, and helps with bone development. Sources: Nuts, seeds, whole grains, avocados, and bananas.",
            ],
          },
          {
            title: "General Nutrition Tips for the Second Trimester",
            bulletPoints: [
              "Eat Small, Frequent Meals: Your growing uterus may crowd your stomach, making large meals uncomfortable.",
              "Stay Hydrated: Drink at least 8-10 glasses of water daily to support digestion and circulation.",
              "Limit Empty Calories: Focus on nutrient-dense foods while occasionally enjoying treats.",
              "Watch for Heartburn: Avoid spicy or greasy foods, eat smaller meals, and sleep slightly elevated.",
              "Monitor Weight Gain: Maintain a healthy rate of weight gain; discuss your target with your provider.",
            ],
          },
          {
            ...
            bulletPoints: [
              ...
              "Unpasteurized Dairy and Juices: Always choose pasteurized options to avoid harmful bacteria.",
              "Raw or Undercooked Foods: Avoid raw eggs, sushi, or undercooked meat.",
              "Caffeine and Alcohol: Limit caffeine to 200mg/day (12oz coffee) and avoid alcohol entirely.",
            ],
          },
          {
            title: "Nutrition Nugget: Balanced Eating",
            bulletPoints: [
              "Eating a variety of whole foods during the second trimester ensures you and your baby get all the essential nutrients. Think of your plate as a mix of colorful vegetables, lean proteins, whole grains, and healthy fats. Every bite you take helps your baby grow and thrive!",
            ],
          },
        ],
      },
        ...
        sections: [
          {
            ...
            bulletPoints: [
              "Hierro: Apoya el aumento de tu volumen sanguíneo y ayuda a prevenir la anemia. Fuentes: Carne roja, espinaca, lentejas, semillas de calabaza y cereales fortificados. Consejo: Combínalo con vitamina C para una mejor absorción.",
              "Calcio y Vitamina D: Ayudan a formar huesos y dientes fuertes y previenen la pérdida de densidad ósea. Fuentes: Productos lácteos, leches vegetales fortificadas, verduras de hoja verde, tofu, almendras y huevos. Consejo: Pasa de 10 a 15 minutos al sol diariamente para aumentar la vitamina D de forma natural.",
              "Ácidos Grasos Omega-3 (DHA): Apoyan el desarrollo del cerebro y los ojos del bebé. Fuentes: Pescados grasos como el salmón, semillas de chía, linaza, nueces y suplementos. Consejo: Elige pescados bajos en mercurio y consume 2-3 porciones por semana.",
              "Proteína: Es esencial para el crecimiento y desarrollo de los tejidos del bebé. Fuentes: Pollo, pavo, huevos, frijoles, lentejas, tofu, yogur griego y nueces. Consejo: Consume entre 70 y 100 gramos de proteína al día.",
              "Fibra: Ayuda a prevenir el estreñimiento, un problema común en el embarazo. Fuentes: Granos integrales, frutas (bayas, manzanas, peras),
  }
};
