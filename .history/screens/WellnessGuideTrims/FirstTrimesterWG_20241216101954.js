...
const renderTabContent = (topic) => {
  if (!topic) {
    console.error("No topic found for this tab.");
...
const FirstTrimester = () => {
  ...
  // Define the routes for the tabs dynamically from topics
  ...
  const renderScene = ({ route }) => {
    ...
    console.log("Rendering topic for route:", route.key, topic); // Debugging
    return renderTabContent(topic);
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <TabView
        ...
        lazy={false} // Disable lazy loading for debugging
      />
    </View>
  );
};
