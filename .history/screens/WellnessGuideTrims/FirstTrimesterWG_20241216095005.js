...
const FirstTrimester = () => {
  ...
  const renderScene = ({ route }) => {
    if (route.key === "sleep") {
    ...
    } else if (route.key === "mentalHealth") {
      return (
        <SectionTab
          title="Mental Health"
      ...
      return (
        <SectionTab title="Exercise" imageKey="exercise" dataKey="exercise" />
      );
    } else if (route.key === "symptoms") {
      return (
        <SectionTab
    ...
    return null; // Default case if the route doesn't match any key
  };
