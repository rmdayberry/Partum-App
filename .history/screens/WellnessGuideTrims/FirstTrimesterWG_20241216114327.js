...
const styles = StyleSheet.create({
  ...
  tabBarWrapper: {
    ...
    height: 50, // Fixed height for tab bar wrapper
    justifyContent: "center", // Ensure tabs are vertically aligned
    zIndex: 1,
  },
  tabBar: {
    flexDirection: "row",
  ...
  scene: {
    ...
    paddingHorizontal: 16, // Horizontal padding for consistency
    paddingTop: 16, // Adds a small gap between the tab bar and content
    marginTop: 0, // Explicitly removes any unintended margin
