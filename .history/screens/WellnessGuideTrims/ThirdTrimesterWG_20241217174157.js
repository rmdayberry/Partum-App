...
const translations = {
  ...
  support: {
    English: {
      ...
      sections: [
        {
          title: "1. Creating a Circle of Support",
          bulletPoints: [
        ...
        {
          title: "3. For Those Without a Partner or Limited Family Support",
          bulletPoints: [
        ...
        {
          title: "4. Navigating Complex Family Dynamics",
          bulletPoints: [
        ...
        {
          title: "5. Ways to Support Yourself",
          bulletPoints: [
    ...
    Español: {
      ...
      sections: [
        {
          title: "1. Creando un Círculo de Apoyo",
          bulletPoints: [
        ...
        {
          title: "3. Para Quienes No Tienen Pareja o Apoyo Familiar Limitado",
          bulletPoints: [
        ...
        {
          title: "4. Navegando Dinámicas Familiares Complicadas",
          bulletPoints: [
        ...
        {
          title: "5. Formas de Apoyarte a Ti Misma",
          bulletPoints: [
    ...
    <View style={styles.container}>
      ...
      <ScrollView horizontal contentContainerStyle={styles.tabBar}>
        {[
          ...
          {
            key: "support",
            label: languagePreference === "Español" ? "Parto" : "Support",
          },
        ].map((tab) => (
          <TouchableOpacity
            key={tab.key}
