...
const translations = {
    ...
    sections: [
      ...
      },
      {
        ...
        bulletPoints: [
          ...
          "Maneja el Estrés: Practica la respiración profunda, yoga o lleva un diario para reducir la ansiedad.",
        ],
      },
      {
  ...
  exercise: {
    English: {
      ...
      content:
        "As you transition into your second trimester, many people notice an increase in energy compared to the first trimester. This is a great time to incorporate regular exercise into your routine.",
      sections: [
        {
        ...
        {
          title: "Safe and Beneficial Exercises",
          bulletPoints: [
            ...
            "Prenatal Yoga: Improves flexibility, strengthens muscles, and reduces discomforts like back pain.",
            ...
            "Stretching: Relieves tension and improves range of motion.",
          ],
        },
        {
          title: "Tips for Exercising Safely",
          bulletPoints: [
            ...
            "Avoid Certain Movements: Skip exercises that involve lying flat on your back or high-risk activities.",
            "Warm Up and Cool Down: Always begin with a light warm-up and finish with stretches.",
          ],
        },
        {
    ...
    Español: {
      ...
      content:
        "Al entrar en el segundo trimestre, muchas personas notan un aumento de energía en comparación con el primer trimestre. Este es un excelente momento para incorporar el ejercicio regular en tu rutina.",
      sections: [
        {
          ...
          bulletPoints: [
            ...
            "Prepara tu cuerpo para el parto: Mantenerte activa ayuda a conservar la fuerza y la resistencia necesarias para el trabajo de parto y el parto.",
            "Apoya un aumento de peso saludable: El ejercicio puede ayudarte a manejar el aumento de peso durante el embarazo de manera saludable.",
          ],
        },
        {
          title: "Ejercicios Seguros y Beneficiosos para el Segundo Trimestre",
          bulletPoints: [
            "Caminar: Un paseo diario mejora la circulación, fortalece los músculos y te permite disfrutar del aire libre.",
            "Natación: La flotación en el agua alivia la presión en la espalda y las articulaciones, mientras proporciona un ejercicio completo para el cuerpo.",
            "Yoga Prenatal: Mejora la flexibilidad, fortalece los músculos y reduce molestias como el dolor de espalda.",
            "Entrenamiento de Fuerza: Utiliza pesas ligeras o bandas de resistencia para mantener el tono muscular.",
            "Ciclismo Estacionario: Una opción de cardio de bajo impacto sin el riesgo de caídas.",
            "Estiramientos: Alivian la tensión y mejoran tu rango de movimiento, facilitando los movimientos diarios.",
          ],
        },
        {
          title: "Consejos para Ejercitarte de Forma Segura",
          bulletPoints: [
            "Escucha a tu Cuerpo: Evita esforzarte demasiado. Si sientes mareo, falta de aire o incomodidad, detente y descansa.",
            "Mantente Hidratada: Bebe suficiente agua antes, durante y después del ejercicio.",
            "Usa Ropa y Equipo de Apoyo: Invierte en zapatillas deportivas cómodas y un sostén deportivo adecuado.",
            "Evita Ciertos Movimientos: Omite ejercicios que impliquen acostarte boca arriba o actividades con alto riesgo de caídas.",
            "Calienta y Enfría: Siempre comienza con un calentamiento ligero y termina con estiramientos suaves para evitar lesiones.",
          ],
        },
        {
