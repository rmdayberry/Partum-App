...
const Login = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={StyleSheet.container}>
      ...
      <View style={styles.inputContainer}>
        <Text style={styles.lightText}>Constraseña</Text>
        <TextInput
          style={styles.input}
      ...
      >
        <Text style={styles.registerText}>
          Don't have an account? <Text style={styles.lightText}>¿No tienes una cuenta?</Text>{" "}Register here.{" "} <Text style={styles.lightText}>Regístrate aquí</Text>
        </Text>
      </TouchableOpacity>
    </ScrollView>
  );
