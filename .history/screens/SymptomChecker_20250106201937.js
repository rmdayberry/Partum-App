...
const styles = StyleSheet.create({
  ...
  header: {
    padding: 16,
    backgroundColor: "#F57C00", // Vibrant orange for header
  ...
  subtitle: {
    fontSize: 16,
    fontWeight: "400",
    color: "#FFE5CC", // Softer white-orange for contrast
    textAlign: "center",
    marginTop: 8,
  },
  list: {
  ...
  categoryCard: {
    marginBottom: 16,
    padding: 16,
    backgroundColor: "#FFF3E0", // Light orange for category background
    borderRadius: 12,
  },
  categoryTitle: {
    fontSize: 20,
    fontWeight: "600",
    marginBottom: 12,
    color: "#4A4A4A", // Neutral gray for titles
  },
  sectionCard: {
    marginBottom: 12,
    padding: 12,
  ...
  sectionContent: {
    fontSize: 16,
    lineHeight: 22,
    color: "#626567", // Slightly lighter gray for content
  },
});
