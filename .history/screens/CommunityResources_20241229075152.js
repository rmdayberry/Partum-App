  ...
  const resources = [
    {
      ...
      onPress: () => Linking.openURL("https://example.com/transportation"),
    },
    {
      title: "WIC Program",
      description:
      ...
      onPress: () =>
        Linking.openURL("https://www.health.state.mn.us/people/wic/index.html"),
    },
    {
      title: "Insurance",
      description:
      ...
      onPress: () => Linking.openURL("https://example.com/insurance"),
    },
    {
      title: "Food Banks",
      description:
      ...
      onPress: () => Linking.openURL("https://example.com/foodbanks"),
    },
  ];
