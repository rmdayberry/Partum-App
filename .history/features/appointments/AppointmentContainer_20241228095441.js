...
const styles = StyleSheet.create({
  ...
  appointmentContainer: {
    borderRadius: 12,
    backgroundColor: "#F7F9FC", // Light fill color
    borderStyle: "solid",
    ...
    marginBottom: 16, // Spacing below the container
    width: "90%", // Adjust to fit within the dashboard layout
    alignSelf: "center", // Center container on the page
  },
  // Countdown text
  countdownContainer: {
    fontFamily: "Arial",
  ...
  directionsButton: {
    ...
    alignItems: "center",
    justifyContent: "center",
    backgroundColor: "#6A5ACD", // Primary button color
