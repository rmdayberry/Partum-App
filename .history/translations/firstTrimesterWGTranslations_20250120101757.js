export const translations = {
  ...
  symptoms: {
    English: {
      ...
      title3: "Nausea and Vomiting",
      content3: [
        "Feeling nauseated or throwing up is very common in early pregnancy, though it can feel miserable. Here are some tips to help you manage:",
    ...
    Español: {
      ...
      content2: [
        "Senos Sensibles",
        "Tus senos pueden crecer y sentirse tiernos o sensibles.",
      ...
      title3: "Náuseas y Vómitos",
      content3: [
        "Sentir náuseas o vomitar es muy común al principio del embarazo. Aquí tienes algunos consejos para manejarlas:",
