    ...
    >
      ...
      <View style={[DashboardStyles.frame3, styles.frameLayout]}>
        ...
        <View style= {DashboardStyles.tip}>
          ...
          <Text style= {DashboardStyles.moreTipsOn}>More tips on staying hydrated ▶️</Text>
        </View>
      </View>
      <Pressable style= {DashboardStyles.frameChild} onPress={()=> navigation.navigate("Education")}></Pressable>
    </ScrollView>
  );
};
